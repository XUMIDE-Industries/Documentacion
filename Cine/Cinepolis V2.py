...
class CinepolisGUI:
    ...
    def _mostrar_resumen_final(self):
        ...
        lbl_info = tk.Label(resumen, text=texto, font=("Arial", 11, "bold"),
                            justify="left", bg="#f4f4f4", fg="black", anchor="w")
        lbl_info.place(x=30, y=20)

        # Gráfica de barras con productos vendidos
        fig, ax = plt.subplots(figsize=(5.5, 3.5), facecolor='#f4f4f4')
        ...
        ax.set_title("Productos Vendidos", color="black", fontsize=12)
        ax.set_ylabel("Cantidad", color="black")
        ax.set_xlabel("Producto", color="black")
